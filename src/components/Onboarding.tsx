...
const SLIDES = [{"accent": "#8b5cf6", "icon": "\ud83e\uddf9", "title": "Deep clean your\nPC in one tap", "desc": "Remove browser cache, temp files, system junk, and redundant logs. Reclaim gigabytes instantly."}, {"accent": "#7c3aed", "icon": "\ud83d\udd12", "title": "Wipe tracking\ndata completely", "desc": "Delete browsing history, search history, download logs, and autocomplete data across all browsers."}, {"accent": "#5b21b6", "icon": "\u26a1", "title": "Run faster.\nStay private.", "desc": "A cleaner PC is a faster PC. And one that reveals less about you to anyone who might look."}];
  ...
  return (
    <div style={{ minHeight:'100vh', display:'flex', flexDirection:'column', background:'#080808', position:'relative', overflow:'hidden' }}>
      ...
      <div style={{ padding:'20px 24px', display:'flex', justifyContent:'flex-end' }}>
        <button onClick={onDone} style={{ color:'#8b5cf660', fontSize:'14px', background:'none', border:'none', cursor:'pointer', fontFamily:'Inter' }}>Skip</button>
      </div>
      <div key={idx} style={{ flex:1, display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', padding:'20px 32px', textAlign:'center', animation:'si 0.35s ease' }}>
        ...
        <p style={{ color:'#8b5cf685', fontSize:'15px', lineHeight:'1.7', maxWidth:'280px' }}>{slide.desc}</p>
      </div>
